 ...
 * Edit experiment.yaml and run `npm run setup` to regenerate.
 */
...
var CONFIG = {
  ...
  DEMOGRAPHIC_INSTRUCTIONS_HTML: "<p>Awesome!</p> <p>For this last part of the experiment, please provide us with information about yourself.</p>",
  GOODBYE_HTML: "Woohoo! You have finished the experiment.<br> Click the button below to complete the experiment.<br><br>",
  SECRET_CODE_HTML: "<strong> Here is your secret code: {{SECRET_CODE}} </strong><br>",
  COMPLETE_BUTTON_TEXT: "Complete Experiment",

  // ── Demographic questions ──────────────────────────────
  RACE_ETHNICITY_PROMPT: "Which categories describe you? Select all that apply to you:",
  ...
  AGE_COLUMNS: 6,
  GENDER_PROMPT: "How do you currently describe your gender identity? Please specify.",
  GENDER_COLUMNS: 60,
};
